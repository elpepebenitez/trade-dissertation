...
def add_abstract(doc):
    ...
    doc.append("Extensions to the Gravity Model of Trade are used to empirically estimate across regions the heterogeneous partial effects of Preferential Trade Agreements (PTAs) signed between 2000 and 2010 on trade volumes and value per unit of manufacturing products exported, as well as the effects on North-North, North-South and South-South bilateral trade relationships. We find that the average “total” partial effects of PTAs in the period studied are similar to the estimates of the relevant literature, but there are heterogeneous effects of specific agreements within regions both on trade volume and value per unit. We also find heterogeneous effects of PTAs on the different categories of bilateral trade relationships. We found examples of PTAs having both positive and negative effects on both North-South and South-South trade.")
