...
def add_abstract(doc):
    ...
    doc.append(NoEscape(r'\vspace*{\fill}'))  # Ensure keywords are at the bottom
    doc.append(NoEscape(r'\begin{flushleft}'))
    doc.append(NoEscape(r'\textbf{Keywords:} “Trade Agreements”; “South-South”; “North-South”; “International Trade”; “Exports”; “Export Product Unit Value”; “Gravity Model”.'))
