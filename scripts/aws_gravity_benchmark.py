...
# gravity_file_key = 'Gravity_V202211.csv'
# trade_file_key = 'TPe_V202401.csv'
...
#     print(f"Downloaded {key} from S3 bucket {bucket_name} to {local_path}")

# # Download files from S3
# gravity_local_path = '/tmp/Gravity_V202211.csv'
# trade_local_path = '/tmp/TPe_V202401.csv'
# country_key_local_path = '/tmp/TradeProd_Gravity_country_key.csv'

# download_from_s3(bucket_name, gravity_file_key, gravity_local_path)
# download_from_s3(bucket_name, trade_file_key, trade_local_path)
# download_from_s3(bucket_name, country_key_file_key, country_key_local_path)

# # Read the downloaded files
# trade_data = pd.read_csv(trade_local_path, low_memory=False)
# gravity_data = pd.read_csv(gravity_local_path, low_memory=False)
# country_key = pd.read_csv(country_key_local_path, low_memory=False)
...
#     # Save LaTeX table to a file in the S3 bucket
#     s3.put_object(Bucket=bucket_name, Key='benchmark_results_table.tex', Body=latex_table)
